...
const ProfilePageUsers = () => {
  ...
  const [mostraStatistiche, setMostraStatistiche] = useState("Fortnite");
  ...
  const getUtente = () => {
    fetch(`${process.env.REACT_APP_BACKEND}/user/${params.id}`, {
      method: "GET",
      headers: {
      ...
      {userData ? (
        <div className="">
          ...
          <div className="container-fluid mb-5">
            <div className="row sezioneProfilo justify-content-center">
