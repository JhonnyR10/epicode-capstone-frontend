...
const ProfileMatch = ({ utente, setView, setIndex, toggleClicked }) => {
  ...
  const mostraAlertOStatistiche = () => {
    if (!utente.vip && utente.matches && utente.matches.length >= 10) {
      return (
        <Alert variant="warning" onClick={() => navigate("/vip")}>
          Sei al limite di match! <strong>Diventa VIP</strong> per accedere a
          più match e vantaggi esclusivi.
        </Alert>
      );
    }
    // Continua a mostrare il contenuto delle statistiche qui
    // Questo è lo spazio dove puoi inserire la logica per mostrare le statistiche dei giochi
  };
  //   return (
  //     <div className="cardUser">
  //       <div className=" row justify-content-center">
  //         {mostraAlertOStatistiche()}
  ...
  return (
    <div className="cardUser">
      <div className="row justify-content-center">
        {/* Controllo se mostrare alert o statistiche */}
        {!utente.vip && utente.matches && utente.matches.length >= 10 ? (
          <Alert variant="warning" onClick={() => navigate("/vip")}>
            Sei al limite di match! <strong>Diventa VIP</strong> per accedere a
            più match e vantaggi esclusivi.
          </Alert>
